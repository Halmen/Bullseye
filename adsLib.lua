...
--  ["chartboostplugin"] = {  
--    ["Android"] = {
--      appId = "548a8dbe04b016255a81e7da",
--      appSignature = "03e3f41888d62beec017fa5c07471844e98e38f2",
--      appVersion = "1.0"
--    },
--    ["iPhone"] = {
--      appId = "5526158504b01658522ed342",
--      appSignature = "2338b8258cc4431f36bfe6f87c16a9061ea8bb14",
--      appVersion = "1.0"
--    }
--  },
--  ["chartboost"] = {  
--    ["Android"] = {
--      appId = "537ed0f91873da03d11ab263",
--      appSignature = "2b53ed547f375008dbc4dae9cbbbec0fc40ca556",
--      appVersion = "1.0"
--    },
--    ["iPhone"] = {
--      appId = "5526158504b01658522ed342",
...
--  },
  ...
  ["revmob"] = {
    ["Android"] = {
      appId = "554b35295a714cee0a8db262"
    },
    ["iPhone"] = {
  ...
  ["admob"] = {
    ["Android"] = {
      ...
      bannerId = "ca-app-pub-8819409781798254~3625567521",
      interstitialId = "ca-app-pub-8819409781798254~3625567521"
    },
    ["iPhone"] = {
      pluginVersion = 2, --SPECIFY IF YOU'RE USING VERSION 1 (OLD) OF THE PLUGIN, OR VERSION 2 (NEW). DIFFERENCIES CAN BE FOUND HERE: http://coronalabs.com/blog/2014/07/15/tutorial-implementing-admob-v2/
...
--    end
--  },
--  ["chartboost"] = {   --   native.showAlert( "No ad available", "In show.", { "OK" });
--
--    ["interstitial"] = function(providerData, adData)
--      if providerData.mustBeCached then
--        if not chartboost.hasCachedInterstitial() then
...
adsLib.showAd = function(adId)
  ...
  --native.showAlert( "No ad available", "Please cache an ad." .. chosenProvider.providerName .. selectedAd.adType, { "OK" });
